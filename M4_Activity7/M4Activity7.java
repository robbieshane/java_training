...
class BankAccount2 {
    private static final Logger logger = LoggerFactory.getLogger(BankAccount2.class);
...
public class M4Activity7 {
	...
	public static void runTest(BankTestOperation1 operation, String operationName) {
        try {
            operation.execute();
	...
	public static void main(String[] args) {
		BankAccount2 account = new BankAccount2(10000);
